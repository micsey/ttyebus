...
// The UART interrupt on RASPI2,3 is allocated to 87, beginning with kernel 4.19.42,
// it is allocated to 81 and from kernel 5.x.x interrupt is allocated to 114.
...
//
// ===============================================================================================
static void ttyebus_gpio_pullupdown(unsigned int Gpio, unsigned int pud)
    {
...
//
// ===============================================================================================
unsigned int ttyebus_poll(struct file* file_ptr, poll_table* wait)
    {
#ifdef DEBUG
...
//
// ===============================================================================================
static int ttyebus_register(void)
    {
    int result;
...
//
// ===============================================================================================
static void ttyebus_unregister(void)
    {
